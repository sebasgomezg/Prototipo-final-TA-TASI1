...
import { Plus, Calendar, List, MoreVertical, LogOut, Plane, ChevronRight, CreditCard, Users, Smartphone, LayoutGrid } from 'lucide-react';
                ...
                return (
                    ...
                    >
                        <div className={`w-12 h-12 rounded-full flex items-center justify-center shrink-0 ${isIncome ? 'bg-emerald-100 text-emerald-500' : 'bg-red-100 text-red-500'}`}>
                            {isIncome ? <Plus className="w-6 h-6" /> : <Plus className="w-6 h-6 rotate-45" />}
                        </div>
